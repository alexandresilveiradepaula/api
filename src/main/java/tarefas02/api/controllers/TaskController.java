...
import tarefas02.api.models.Task; // importa a entidade Task do pacote de modelos do projeto
import tarefas02.api.services.TaskService; // Importa a caçassse de serviço TaskService do projeto
